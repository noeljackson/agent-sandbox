...
type SandboxTemplateInterface interface {
	...
	Apply(ctx context.Context, sandboxTemplate *applyconfigurationapiv1alpha1.SandboxTemplateApplyConfiguration, opts v1.ApplyOptions) (result *apiv1alpha1.SandboxTemplate, err error)
	SandboxTemplateExpansion
}

// sandboxTemplates implements SandboxTemplateInterface
type sandboxTemplates struct {
	*gentype.ClientWithListAndApply[*apiv1alpha1.SandboxTemplate, *apiv1alpha1.SandboxTemplateList, *applyconfigurationapiv1alpha1.SandboxTemplateApplyConfiguration]
}
...
func newSandboxTemplates(c *ExtensionsV1alpha1Client, namespace string) *sandboxTemplates {
	return &sandboxTemplates{
		gentype.NewClientWithListAndApply[*apiv1alpha1.SandboxTemplate, *apiv1alpha1.SandboxTemplateList, *applyconfigurationapiv1alpha1.SandboxTemplateApplyConfiguration](
			"sandboxtemplates",
			c.RESTClient(),
