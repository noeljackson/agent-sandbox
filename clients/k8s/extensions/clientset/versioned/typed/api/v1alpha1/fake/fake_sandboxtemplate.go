...
import (
	...
	typedapiv1alpha1 "sigs.k8s.io/agent-sandbox/clients/k8s/extensions/clientset/versioned/typed/api/v1alpha1"
...
type fakeSandboxTemplates struct {
	*gentype.FakeClientWithListAndApply[*v1alpha1.SandboxTemplate, *v1alpha1.SandboxTemplateList, *apiv1alpha1.SandboxTemplateApplyConfiguration]
	Fake *FakeExtensionsV1alpha1
}

func newFakeSandboxTemplates(fake *FakeExtensionsV1alpha1, namespace string) typedapiv1alpha1.SandboxTemplateInterface {
	return &fakeSandboxTemplates{
		gentype.NewFakeClientWithListAndApply[*v1alpha1.SandboxTemplate, *v1alpha1.SandboxTemplateList, *apiv1alpha1.SandboxTemplateApplyConfiguration](
			fake.Fake,
			namespace,
