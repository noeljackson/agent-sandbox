...
func (b *PersistentVolumeClaimTemplateApplyConfiguration) ensureEmbeddedObjectMetadataApplyConfigurationExists() {
...
func (b *PersistentVolumeClaimTemplateApplyConfiguration) WithSpec(value v1.PersistentVolumeClaimSpec) *PersistentVolumeClaimTemplateApplyConfiguration {
	b.Spec = &value
	return b
}
