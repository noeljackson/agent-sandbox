...
EXT_APPLYCONFIG_EXTERNALS="sigs.k8s.io/agent-sandbox/api/v1alpha1.PodMetadata:${APPLYCONFIG_PKG}/api/v1alpha1"
EXT_APPLYCONFIG_EXTERNALS+=",sigs.k8s.io/agent-sandbox/api/v1alpha1.PodTemplate:${APPLYCONFIG_PKG}/api/v1alpha1"
EXT_APPLYCONFIG_EXTERNALS+=",sigs.k8s.io/agent-sandbox/api/v1alpha1.PersistentVolumeClaimTemplate:${APPLYCONFIG_PKG}/api/v1alpha1"
